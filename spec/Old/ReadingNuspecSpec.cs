...
namespace MooGet.Specs {
	...
	public class ReadingNuspecSpec : MooGetSpec {
		...
		public void NUnit_example() {
			...
			package.VersionText.ShouldEqual("2.5.7.10213");
		...
		public void FluentNHibernate_example() {
			...
			package.VersionText.ShouldEqual("1.1.0.694");
			...
			package.Dependencies.First().VersionText.ShouldEqual("2.1.2.4000");
			package.Dependencies.First().MinVersionText.Should(Be.Null);
			package.Dependencies.First().MaxVersionText.Should(Be.Null);
		...
		public void CrazyLibrary_example() {
			...
			package.VersionText.ShouldEqual("0.3.6");
			...
			package.Dependencies.First(d => d.Id == "WebActivator").VersionText.Should(Be.Null);
		...
		public void can_read_tags() {
			...
			package.VersionText.ShouldEqual("1.0.2.5");
